...
exports['default'] = function (css, rootName) {
  ...
  function buildBemClasses(self, node) {
    ...
    var className = (0, _classnames2['default'])(css[rootName], !allKlzzs.length ? null : allKlzzs, node.props.className, self.props.className);
    ...
    return (function (_DecoredComponent) {
      ...
      _createClass(WrapComponent, [{
        ...
        value: function render() {
          var el = _get(Object.getPrototypeOf(WrapComponent.prototype), 'render', this).call(this);
          if (!el) return el;

          var props = buildBemClasses(this, el);
          return !props ? el : (0, _react.cloneElement)(el, { props: props });
        }
      }]);
